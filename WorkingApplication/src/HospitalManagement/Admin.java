	...
	public static void main(String args[]) {
		...
		while (true) {
			...
			case 7: {
				...
				int MAX_CAPACITY = 5;
				Thread tDoctor = new Thread(new AssignDoctorToPatient(taskQueue, MAX_CAPACITY), "Doctor");
				Thread tPatient = new Thread(new AssignPatientToDoctor(taskQueue), "Patient");
				tDoctor.start();
				tPatient.start();
			}
				break;
